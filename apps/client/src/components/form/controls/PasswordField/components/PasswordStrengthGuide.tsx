...
function PasswordStrengthGuide({ value, isTouched }: PasswordStrengthGuideProps) {
  ...
  return (
    <div className="space-y-1.5">
      ...
      >
        <Typography>
          A strong password helps keep your account safe. Use at least 8 letters, numbers and
          symbols.
        </Typography>
