...
function SettingsSidebar() {
  ...
  return (
    <div
      className={cn(
        "fixed inset-y-0 left-0 z-sub-sidebar flex w-sub-sidebar-width flex-col border-r border-gray-300 bg-background p-3 transition-transform duration-sidebar",
        subSidebar === "settings"
